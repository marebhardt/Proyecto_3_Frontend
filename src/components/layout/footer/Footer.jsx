    ...
    return (
        <Box
            ...
            <Box className="footer__groups">
                <Box>
                    <h4 className="footer__groups__title">👨🏻‍💻👩🏻‍💻Navegar</h4>
                ...
                <Box>
                    <h4 className="footer__groups__title">🖊️ Legales </h4>
                ...
                <Box>
                    <h4 className="footer__groups__title">Redes Sociales 📲</h4>
            ...
            <Box className="footer__copyright">
                <span>&copy;2024  M.E 💮  Desarrollos</span>
            </Box>
        </Box>
    );
};
